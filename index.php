    ...
    <header>
        ...
        <nav class="nav__container">
            ...
            <div class="nav__categories__container">
                <ul>
                    <li class="nav__mobile--links nav__mobile--active"><a href="">PRODUCTS</a></li>
                    <li class="nav__mobile--links"><a href="">FEATURED</a></li>
                    <li class="nav__mobile--links"><a href="">FUNATICS!</a></li>
                </ul>
            </div>
